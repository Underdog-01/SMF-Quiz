...
if (!empty($_SERVER['QUERY_STRING']) && is_string($_SERVER['QUERY_STRING']) && (stripos($_SERVER['QUERY_STRING'], $boardurl) !== FALSE || stripos($_SERVER['QUERY_STRING'], str_replace('https:', 'http:', $boardurl)) !== FALSE)) {
